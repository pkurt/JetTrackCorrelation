...
int main(int argc, char *argv[])
{
  ...
  parti = atoi(argv[3]);
  assert(trkPtCut > 0.49 && trkPtCut < 5.);
        ...
        for(int tracks =0; tracks < (int) my_primary->trkPt->size(); tracks++){
          ...
          if (my_primary->highPurity->at(tracks)==1) {
            if(my_primary->trkPt->at(tracks)>trkPtCut) {
              ...
              trkweight = (1-my_primary->fake->at(tracks))/my_primary->eff->at(tracks);
              ...
              //              std::cout << "evi: " << evi << ", trkweight: " << trkweight << ", wvz: " << wvz << ", wcen: " << wcen << "\n";
              //             if( evi == 97 ) {
              //                std::cout << "evi: " << evi << ", fill deta: " << deta << ", dphi: " << dphi << ", into bins: " << my_hists->hJetTrackSignalBackground[ibin][ibin2][ibin3]->GetYaxis()->FindBin(dphi) << "," <<  my_hists->hJetTrackSignalBackground[ibin][ibin2][ibin3]->GetYaxis()->
