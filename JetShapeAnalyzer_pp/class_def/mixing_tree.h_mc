...
// Fri Mar 14 03:59:32 2014 by ROOT version 5.32/00
// from TTree mixing_tree/
// found on file: /afs/cern.ch/work/p/pkurt/private/datasets/new_reco_minintuples/pp_mc/Pythia80_ak3CaloJets_mini_ntuple_v1_p0.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/p/pkurt/private/datasets/new_reco_minintuples/pp_mc/Pythia80_ak3CaloJets_mini_ntuple_v1_p0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/p/pkurt/private/datasets/new_reco_minintuples/pp_mc/Pythia80_ak3CaloJets_mini_ntuple_v1_p0.root");
      }
