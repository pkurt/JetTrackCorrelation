...
class hist_class {
  public:
    ...
    TH1F* track_bkg_eta_hist_weighted[nCBins][nPtBins];
    TH1F* track_bkg_eta_hist[nCBins][nPtBins];
    TH1F* track_gen_bkg_eta_hist[nCBins][nPtBins];
    ...
    TH1F* track_cand_eta_hist_weighted[nCBins][nPtBins];
    TH1F* track_cand_phi_hist_weighted[nCBins][nPtBins];
...
hist_class::hist_class(TString the_desc, bool is_it_data) {
  ...
  for (int ibin=0;ibin<nCBins;ibin++){
    ...
    for (int ibin2=0;ibin2<nPtBins;ibin2++){ 
      ...
      track_cand_phi_hist[ibin][ibin2] = new TH1F((TString) (desc + "_track_cand_phi_hist"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", 72, -TMath::Pi(),TMath::Pi());     track_cand_phi_hist[ibin][ibin2]->Sumw2();
      ...
      track_cand_pT_hist_weighted[ibin][ibin2] = new TH1F((TString) (desc + "_track_cand_pT_hist_weighted"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", nPtBintrk,ptBintrk);     track_cand_pT_hist_weighted[ibin][ibin2]->Sumw2();
        ...
        track_cand_eta_hist_weighted[ibin][ibin2] = new TH1F((TString) (desc + "_track_cand_eta_hist_weighted"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", 50, -5., 5.);     track_cand_eta_hist_weighted[ibin][ibin2]->Sumw2();

	        track_cand_phi_hist_weighted[ibin][ibin2] = new TH1F((TString) (desc + "_track_cand_phi_hist_weighted"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", 72, -TMath::Pi(), TMath::Pi());     track_cand_phi_hist_weighted[ibin][ibin2]->Sumw2();
...
///////// gen level eta-phi-pt spectras
      ...
      track_gen_pT_hist[ibin][ibin2] = new TH1F((TString) (desc + "_track_gen_pT_hist"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", nPtBintrk,ptBintrk);   track_gen_pT_hist[ibin][ibin2]->Sumw2();
        ...
        track_gen_eta_hist[ibin][ibin2] = new TH1F((TString) (desc + "_track_gen_eta_hist"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", 50, -5., 5.);   track_gen_eta_hist[ibin][ibin2]->Sumw2();

	        track_gen_phi_hist[ibin][ibin2] = new TH1F((TString) (desc + "_track_gen_phi_hist"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", 72, -TMath::Pi
...
//// bkg pt spectras
      ...
      track_bkg_pT_hist_weighted_oocone[ibin][ibin2] = new TH1F((TString) (desc + "_track_bkg_pT_hist_weighted_oocone"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", nPtBintrk,ptBintrk);     track_bkg_pT_hist_weighted_oocone[ibin][ibin2]->Sumw2();
            ...
            track_bkg_pT_hist_oocone[ibin][ibin2] = new TH1F((TString) (desc + "_track_bkg_pT_hist_oocone"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", nPtBintrk,ptBintrk);     track_bkg_pT_hist_oocone[ibin][ibin2]->Sumw2();
			    ...
			    track_bkg_eta_hist_weighted[ibin][ibin2] = new TH1F((TString) (desc + "_track_bkg_eta_hist_weighted"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", 50, -5., 5.);     track_bkg_eta_hist_weighted[ibin][ibin2]->Sumw2();


			    track_bkg_eta_hist[ibin][ibin2] = new TH1F((TString) (desc + "_track_bkg_eta_hist"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", 50, -5., 5.);     track_bkg_eta_hist[ibin][ibin2]->Sumw2();

			    track_gen_bkg_eta_hist[ibin][ibin2] = new TH1F((TString) (desc + "_track_gen_bkg_eta_hist"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", 50, -5., 5.);   track_gen_bkg_eta_hist[ibin][ibin2]->Sumw2();
	...
	TrkPhi[ibin][ibin2][ibin3] = new TH1F((TString) (desc + "_TrkPhi"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+ "_" + TrkPtBin_strs[ibin3] + "_" + TrkPtBin_strs[ibin3+1]), "", 72, -TMath::Pi(), TMath::Pi());     TrkPhi[ibin][ibin2][ibin3]->Sumw2();
       ...
       GenTrkPt[ibin][ibin2][ibin3] = new TH1F((TString) (desc + "_GenTrkPt"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+ "_" + TrkPtBin_strs[ibin3] + "_" + TrkPtBin_strs[ibin3+1]), "", 100, 0., 100.);     GenTrkPt[ibin][ibin2][ibin3]->Sumw2();
             ...
             GenTrkEta[ibin][ibin2][ibin3] = new TH1F((TString) (desc + "_GenTrkEta"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+ "_" + TrkPtBin_strs[ibin3] + "_" + TrkPtBin_strs[ibin3+1]), "", 50, -5., 5.);     GenTrkEta[ibin][ibin2][ibin3]->Sumw2();
...
void StudyFiles(std::vector<TString> file_names, int foi, hist_class *my_hists)
{
  ...
  assert(parti >= 0 && parti <= (int) file_names.size() );
  for(int fi = 0; fi < (int) file_names.size(); fi++) {
    if( parti != fi ) continue;
...
//      if (evi%100==0) std::cout << " I am running on file " << fi << " of " << ((int) file_names.size()) << ", evi: " << evi << " of " << n_evt << std::endl;
      ...
      for(int centi = 0; centi < nCBins; centi++) {
	for(int pti = 0; pti < nPtBins; pti++) {
	  if (evi%1000==0) std::cout<< " Integral_gen_bkg : " << hists_track_gen_bkg_pT_hist[centi][pti]-> Integral() << std::endl;
	}
      }
...
/*	  if(j4i>=2){
	    ...
	    my_hists->ThirdJetPt_hist[ibin][ibin2]->Fill(my_primary->jtpt->at(j4i), wvz*wcen);
	    my_hists->ThirdJetEta_hist[ibin][ibin2]->Fill(my_primary->jteta->at(j4i), wvz*wcen);
	    my_hists->ThirdJetPhi_hist[ibin][ibin2]->Fill(my_primary->jtphi->at(j4i), wvz*wcen);
...
//        for(int j4i = 0; j4i < (int) my_primary->jtpt->size(); j4i++) {
	...
	if( !is_data ) {
	  ...
	  if (pthat_mix_new > 120) continue;
	          //if (pthat_mix_new > pthatmax) continue;

	}
        if( evi % 100 == 0 ) {
	  //std::cout << "Matching for mixing for evi " << evi << ", mixentry " << mixentry << std::endl;
	}
	...
	if( fabs(thiscent-my_primary->hiBin) / thiscent > 0.25 ) continue;
        if( evi % 100 == 0 ) {
	  //std::cout << "Matched for mixing for evi " << evi << ", mixentry " << mixentry << std::endl;
	}
	...
	for(int mji = 0; mji < (int) my_primary->jtpt->size(); mji++) {
	  ...
	  if( fabs(my_primary->jteta->at(mji)) > 2 ) continue;
...
//                std::cout << " dEta : " << deta_bkg << "  dPhi : " << dphi_bkg << std::endl;
        ...
        }  /// looping over Mixed events until you find 10
	  ////==== end reco level =====/////////
