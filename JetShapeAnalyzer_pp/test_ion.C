...
hist_class::hist_class(TString the_desc, bool is_it_data) {
  ...
  for (int ibin=0;ibin<nCBins;ibin++){
    ...
    for (int ibin2=0;ibin2<nPtBins;ibin2++){ 
      ...
      track_cand_eta_hist[ibin][ibin2] = new TH1D((TString) (desc + "_track_cand_eta_hist"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", 50, -5., 5.);     track_cand_eta_hist[ibin][ibin2]->Sumw2();
      ...
      track_cand_pT_hist_weighted[ibin][ibin2] = new TH1D((TString) (desc + "_track_cand_pT_hist_weighted"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", nPtBintrk,ptBintrk);     track_cand_pT_hist_weighted[ibin][ibin2]->Sumw2();
        ...
        track_cand_eta_hist_weighted[ibin][ibin2] = new TH1D((TString) (desc + "_track_cand_eta_hist_weighted"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]), "", 50, -5., 5.);     track_cand_eta_hist_weighted[ibin][ibin2]->Sumw2();
