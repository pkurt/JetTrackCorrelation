...
// Tue Nov  5 10:06:40 2013 by ROOT version 5.34/05
// from TTree mixing_tree/
// found on file: /afs/cern.ch/work/p/pkurt/private/shapes/CMSSW_6_2_0_pre3/src/hiforest/jet_track/data_minintuple/input_ntuple/total_pbpb_EP_included.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
  /*    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/p/pkurt/private/shapes/CMSSW_6_2_0_pre3/src/hiforest/jet_track/data_minintuple/input_ntuple/total_pbpb_EP_included.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/p/pkurt/private/shapes/CMSSW_6_2_0_pre3/src/hiforest/jet_track/data_minintuple/input_ntuple/total_pbpb_EP_included.root");
      }
