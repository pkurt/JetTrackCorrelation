...
// Mon Mar 17 06:31:07 2014 by ROOT version 5.32/00
// from TTree mixing_tree/
// found on file: /afs/cern.ch/work/f/fgarb/public/merged_pbpbdata.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
  /*    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/f/fgarb/public/merged_pbpbdata.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/f/fgarb/public/merged_pbpbdata.root");
      }
