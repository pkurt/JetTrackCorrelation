...
// Wed Aug 20 19:32:19 2014 by ROOT version 5.32/00
// from TTree mixing_tree/
// found on file: /afs/cern.ch/work/p/pkurt/private/datasets/new_reco_minintuples/minbias_mc/HydjetMB_mini_ntuple_v1_p0.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
  ...
  /*    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/p/pkurt/private/datasets/new_reco_minintuples/minbias_mc/HydjetMB_mini_ntuple_v1_p0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/p/pkurt/private/datasets/new_reco_minintuples/minbias_mc/HydjetMB_mini_ntuple_v1_p0.root");
      }
